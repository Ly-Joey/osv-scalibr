...
func isOSPURLType(purlType string) bool {
	switch purlType {
	case purl.TypeDebian, purl.TypeApk, purl.TypeRPM, purl.TypeAlpm, purl.TypeOpkg,
		purl.TypeFlatpak, purl.TypeCOS, purl.TypeSnap, purl.TypePacman, purl.TypePortage, purl.TypeNix, purl.TypeDHI:
		return true
	default:
		return false
	}
